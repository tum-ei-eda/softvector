...
public:
	...
	virtual int compare_outputs(int dut_return) {
		...
		if(!dut_return) {
			std::string diff = std::string("diff -BaiEZw ") + filepath_goldenOutput + std::string(" ") + fp_case_output + std::string("\n");
...
class Cvload_encoded_unitstride final
	: public VCase {
public:
...
class Cvstore_encoded_unitstride final
	: public VCase {
public:
...
class Cvload_encoded_stride final
	: public VCase {
public:
	int16_t _vstride{};
...
class Cvstore_encoded_stride final
	: public VCase {
public:
	int16_t _vstride{};
...
class Cvload_segment_unitstride final
	: public VCase {
public:
	uint8_t _vnf{};
...
class Cvstore_segment_unitstride final
	: public VCase {
public:
	uint8_t _vnf{};
...
class Cvload_segment_stride final
	: public VCase {
public:
	uint8_t _vnf{};
	int16_t _vstride{};
...
class Cvstore_segment_stride final
	: public VCase {
public:
	uint8_t _vnf{};
	int16_t _vstride{};
